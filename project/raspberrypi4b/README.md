...
bmp388: SPI interface SCK connected to GPIO11(BCM).
bmp388: SPI interface MISO connected to GPIO9(BCM).
bmp388: SPI interface MOSI connected to GPIO10(BCM).
bmp388: SPI interface CS connected to GPIO8(BCM).
bmp388: IIC interface SCL connected to GPIO3(BCM).
bmp388: IIC interface SDA connected to GPIO2(BCM).
bmp388: INT connected to GPIO17(BCM).
```
